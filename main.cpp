...
MagicInit bishop_magic_init[64] = {
...
int main(int, char**) 
{
    const auto b_attacks = attacks_magic<BISHOP>(magic_table, bishop_magic_init);
    const auto r_attacks = attacks_magic<ROOK>(magic_table, rook_magic_init);
